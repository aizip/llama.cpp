...
int main(int argc, char ** argv) {
    ...
    const std::string input_text = "Below is the query from the users, please call the correct function and generate the parameters to call the function.\n\nQuery: "\
                                    + params.prompt + " \n\nResponse:";
    // init LLM
    ...
    tokens_list = ::llama_tokenize(ctx, input_text, true);
