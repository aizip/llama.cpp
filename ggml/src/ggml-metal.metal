...
// TODO: we need finish this function to accelerate q4_0, q4_0 on metal GPU
template<int64_t D, int64_t Q = 8, int64_t C = 32> // head size, queries per threadgroup, cache items per threadgroup
kernel void kernel_flash_attn_ext_q4_0_q4_0( 
        device const  char * q,
        device const  char * k,
        device const  char * v,
        device const  char * mask,
...
template [[host_name("kernel_flash_attn_ext_q4_0_q4_0_h64" )]] kernel flash_attn_ext_f16_t kernel_flash_attn_ext_q4_0_q4_0<64>;
template [[host_name("kernel_flash_attn_ext_q4_0_q4_0_h80" )]] kernel flash_attn_ext_f16_t kernel_flash_attn_ext_q4_0_q4_0<80>;
template [[host_name("kernel_flash_attn_ext_q4_0_q4_0_h96" )]] kernel flash_attn_ext_f16_t kernel_flash_attn_ext_q4_0_q4_0<96>; // Phi3 is running this
template [[host_name("kernel_flash_attn_ext_q4_0_q4_0_h112")]] kernel flash_attn_ext_f16_t kernel_flash_attn_ext_q4_0_q4_0<112>;
template [[host_name("kernel_flash_attn_ext_q4_0_q4_0_h128")]] kernel flash_attn_ext_f16_t kernel_flash_attn_ext_q4_0_q4_0<128>;
